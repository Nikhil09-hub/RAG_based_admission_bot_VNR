...
| Turnstile flags | `ENABLE_TURNSTILE`, `TURNSTILE_SITE_KEY`, `TURNSTILE_SECRET_KEY` — used to enable server-side challenge verification and frontend widget rendering. |